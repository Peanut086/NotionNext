...
const BLOG = {
  ...
  NOTION_PAGE_ID:
    ...
    'f12b09197d8e4ed5a563fcad455b234a',
  ...
  BIO: process.env.NEXT_PUBLIC_BIO || '左手烫烫烫 右手锟斤拷🍚', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.peanut.icu', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, 博客, JavaScript大王', // 网站关键词 英文逗号隔开
  BLOG_FAVICON: process.env.NEXT_PUBLIC_FAVICON || '/favicon.ico', // blog favicon 配置, 默认使用 /public/favicon.ico，支持在线图片，如 https://img.imesong.com/favicon.png
  BEI_AN: process.env.NEXT_PUBLIC_BEI_AN || '滇ICP备2022008174号-1', // 备案号 闽ICP备XXXXXX
