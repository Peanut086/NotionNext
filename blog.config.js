...
const BLOG = {
  API_BASE_URL:
    ...
    'https://adjoining-vermicelli-7a5.notion.site/api/v3', // API默认请求地址https://www.notion.so/api/v3,可以配置成自己的地址例如：https://[xxxxx].notion.site/api/v3
  // Important page_id！！！Duplicate Template from  https://tanghh.notion.site/02ab3b8678004aa69e9e415905ef32a5
  NOTION_PAGE_ID:
    process.env.NOTION_PAGE_ID || 'f12b09197d8e4ed5a563fcad455b234a',
  THEME: process.env.NEXT_PUBLIC_THEME || 'cyberpunk', // 当前主题
  ...
  LINK: process.env.NEXT_PUBLIC_LINK || 'http://43.228.76.114:3000/', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, 博客, 程序员, 工具', // 网站关键词 英文逗号隔开
